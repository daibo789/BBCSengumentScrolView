...
typedef NS_ENUM(NSUInteger, BBCCategoryViewAlignment) {
    BBCCategoryViewAlignmentLeft,
    BBCCategoryViewAlignmentCenter,
    BBCCategoryViewAlignmentRight
};

@interface BBCCategoryViewCollectionViewCell : UICollectionViewCell
@property (nonatomic, readonly, strong) UILabel *titleLabel;
@end;

@interface BBCCategoryView : UIView

/// titles
@property (nonatomic, copy) NSArray<NSString *> *titles;

/// 分布方式（左、中、右）
@property (nonatomic) BBCCategoryViewAlignment alignment;
